...
class QuestionController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $categories = Category::all();
        $standards = Standard::all();
        return view('question.show', ['question' => $question,'standards'=>$standards, 'categories' => $categories, 'standard_ids' => $standard_ids, 'responses' => $responses]);
    }
    ...
    public function edit($id)
    {
        ...
        $standard_ids = DB::table('question_standard')->where('question_id', '=', $id)->lists('standard_id');
        $categories = Category::all();
        return view('question.edit', ['question' => $question, 'standards' => $standards, 'categories' => $categories, 'topics' => $topics_list, 'standard_ids' => $standard_ids]);
    }
